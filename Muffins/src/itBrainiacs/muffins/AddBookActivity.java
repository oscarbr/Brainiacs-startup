...
public class AddBookActivity extends Activity implements OnClickListener {
	...
	private final static int CAMERA_CATCHING_CODE = 100; // The code for
															// activity request
															// camera
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == CAMERA_CATCHING_CODE) {
			...
			/*
			 * Image has been captured and saved to a path specified in the
			 * intent
			 */
			if (resultCode == RESULT_OK) {
				...
				/*
				 * Something has gone terribly wrong and the application failed
				 * to capture image.
				 */
			} else {
